...
const (
	...
	// GeminiCLIOAuthClientID/Secret are placeholders. Configure real OAuth credentials
	// through runtime settings or environment variables instead of committing them.
